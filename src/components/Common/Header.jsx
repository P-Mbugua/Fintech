    ...
    <>
      <header className="fixed top-0 w-full z-50 bg-white shadow-sm border-b">
        <div className="container mx-auto flex justify-between items-center p-4">
          ...
          {/* Logo */}
          <div className="flex-1 flex justify-center md:justify-start items-center text-4xl font-bold">
          ...
          {/* Search Icon */}
          <button className="md:hidden mx-2">
            <Search size={24} />
          </button>
          
          {/* Cart Icon */}
          <button className="md:hidden flex items-center bg-green-500 text-white px-2 py-1 rounded-full">
